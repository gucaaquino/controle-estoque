...
public class DeletarProducaoVisao extends JFrame{
	...
	//construtor
	public DeletarProducaoVisao(LumanferControle controle, GerenciarProducaoVisao gerenciarProducaoVisao, int id) {
		super("Deletar Produção");
	...
	private void fechar() {
		DeletarProducaoVisao.this.dispose();
	...
	private void deletarProducao() {
		int opcao = JOptionPane.showConfirmDialog(DeletarProducaoVisao.this, "Tem certeza que deseja excluir esse produção?", "CUIDADO", JOptionPane.OK_CANCEL_OPTION);
		
		if(opcao == JOptionPane.OK_OPTION) {
			if(controle.removeProducao(id))
				JOptionPane.showMessageDialog(DeletarProducaoVisao.this, String.format("Produção deletada com sucesso"), "", JOptionPane.INFORMATION_MESSAGE);
			else
				JOptionPane.showMessageDialog(DeletarProducaoVisao.this, String.format("Erro ao deletadar produção"), "", JOptionPane.ERROR_MESSAGE);
