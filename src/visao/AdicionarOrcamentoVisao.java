...
public class AdicionarOrcamentoVisao extends JFrame{
...
//	private JTextField textValorProposta;
	...
	//construtor
	public AdicionarOrcamentoVisao(LumanferControle controle, GerenciarOrcamentosVisao gerenciarOrcamentosVisao) {
		super("Adicionar Orçamento");
	...
	private void inicializaComponentes() {
		...
		spinNumOrc.setMinimum(controle.getNovoNumOrcamento());
	...
	private void fechar() {
		AdicionarOrcamentoVisao.this.dispose();
	...
	private void adicionar() {
		...
		if(controle.adicionaOrcamento(o)) {
			JOptionPane.showMessageDialog(AdicionarOrcamentoVisao.this, String.format("Orçamento cadastrado com sucesso"), "", JOptionPane.INFORMATION_MESSAGE);
			fechar();
		}else
			JOptionPane.showMessageDialog(AdicionarOrcamentoVisao.this, String.format("Erro ao cadastrar orçamento"), "", JOptionPane.ERROR_MESSAGE);
	...
	private void deletarProduto() {
		...
		if(table.getSelectedRowCount() == 1) {
			if(linhaSelecionada < itensTabela.size()) {
	...
	private void pesquisaProduto() {
		GerenciarProdutosVisao g = new GerenciarProdutosVisao(controle, null, null, null, null, null, null, AdicionarOrcamentoVisao.this, null);
	...
	private void adicionarProduto() {	
		if(!textProduto.getText().equals("")) {
			if(ehNumero(textValorProd.getText())) {
				...
				JOptionPane.showMessageDialog(AdicionarOrcamentoVisao.this, String.format("Entre com um valor válido"), "", JOptionPane.ERROR_MESSAGE);
